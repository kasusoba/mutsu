...
// Witty, IP-free room names — mirrors the web's pools in @mutsu/web session.ts.
const RN_VERB = [
  "summon",
  "pause",
  "queue",
...
/** A friendly default room name — mirrors the web's `makeRoomName` (incl. the
 *  2-char anti-collision suffix). */
