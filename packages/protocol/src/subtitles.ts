/**
 * Subtitle parsing (SPEC §13) — WebVTT / SubRip text → `SubtitleCue[]` (times in
 * seconds). Shared by the web room page and the extension (own-tab mode) so both
 * parse uploads identically. Pure, no DOM, no deps beyond the cue type.
 */

import type { SubtitleCue } from "./bridge.ts";
